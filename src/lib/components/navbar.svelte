...
<div class="navbar mb-16 shadow-lg bg-neutral text-neutral-content sticky top-0 z-10">
    <div class="flex-1 px-2 mx-2">
        <!-- Use your logo URL as the src attribute -->
        <img src="https://raw.githubusercontent.com/EveryDayWebThings/Master/main/static/favicon.png" alt="Everyday Web Things Logo" class="logo">
